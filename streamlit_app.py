...
def run_pipeline(df, target_column):
    ...
    # Encode target — always go through LabelEncoder so strings like 'Yes'/'No' are handled,
    # then cast to plain Python int to avoid Arrow/string dtype issues
    ...
    # Force ALL X columns to numeric (bool → int, coerce anything else)
    ...
    # Guarantee int dtype on targets — prevents Arrow string/float conversion errors
